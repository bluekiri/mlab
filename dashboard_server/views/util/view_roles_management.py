...
from dashboard_server.exceptions.role_listener_not_found_exception import RoleListenerNotFoundException
...
def _run_view(cls, fn, *args, **kwargs):
    try:
        ...
        logging.warning("Hey... maybe you forgot to create the listeners for the role %s" % exception.role)
