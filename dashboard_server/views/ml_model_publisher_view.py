...
from dashboard_server.interactor.orchestation.orquestation_interactor import get_clusters, load_model_on_host
...
class MLModelPublisherView(BaseView, metaclass=ViewSecurityListeners):
    ...
    def change_model(self):
        ...
        return json.dumps({"go": url_for("mlmodelpublisherview.index")}), 200, {'ContentType': 'application/json'}
